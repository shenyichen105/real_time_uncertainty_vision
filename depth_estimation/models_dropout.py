...
class ResNet(nn.Module):
    def __init__(self, layers, decoder, output_size, dropout_p=0.2, in_channels=3, pretrained=True):
        ...
        pretrained_model = getattr(resnet_dropout, "resnet{}".format(layers))(pretrained=pretrained, dropout_p=self.dropout_p)
        if in_channels == 3:
